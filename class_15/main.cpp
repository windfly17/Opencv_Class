...
int yoloV3()
{
    ...
    //coco数据集的名称文件，80类
    string classesFile= R"(D:\Desktop\Opencv_Class\coco.names)";
    //yolov3网络模型文件
    String yolov3_model = R"(D:\Desktop\Opencv_Class\yolov3.cfg)";
    //权重
    String weights = R"(D:\Desktop\Opencv_Class\yolov3.weights)";
...
int openpose()
{
    ...
    //读入网络模型和权重文件
    String modelTxt = R"(D:\Desktop\Opencv_Class\openpose_pose_coco.prototxt)";
    String modelBin = R"(D:\Desktop\Opencv_Class\pose_iter_440000.caffemodel)";
    ...
    VideoCapture cap;
    cap.open(R"(D:\Desktop\Opencv_Class\class_15\openposeTest.mp4)");
